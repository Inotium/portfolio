    ...
    >
      <div
        className="relative mb-[15px] md:mb-0 md:absolute md:left-[-30px] md:top-1/2 md:transform md:-translate-y-1/2
                      flex items-center justify-center bg-gradient-to-r from-[#ff7b7b] to-[#7b77ff] rounded-full w-[60px] h-[60px]
                      shadow-[0_0_10px_rgba(0,0,0,0.2)]"
      >
        <span className="text-white text-[16px] font-bold">{experienceData.years}</span>
      </div>
